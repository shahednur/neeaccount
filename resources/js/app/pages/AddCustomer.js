            ...
            <div className="flex">
              {/* Card (Customers) */}
                <div className="mr-4 bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    <label className="form-label inline-block uppercase text-gray-700 text-sm font-bold mb-2" htmlFor="name">
                      Customer Name
                    </label>
                  ...
                  <div className="mb-6 mr-4">
                    <label className="form-label inline-block uppercase text-gray-700 text-sm font-bold mb-2" htmlFor="email">
                      Email
                    </label>
                  ...
                  <div className="mb-6 mr-4">
                    <label className="form-label inline-block uppercase text-gray-700 text-sm font-bold mb-2" htmlFor="phone">
                      Phone
                    </label>
                  ...
                  <div className="mb-6 mr-4">
                    <label className="form-label inline-block uppercase text-gray-700 text-sm font-bold mb-2" htmlFor="website">
                      Website
                    </label>
                  ...
                  <div className="mb-6 mr-4">
                  <label className="form-label inline-block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="rating">
                    Rating
                  </label>
                  <div className="relative">
                    ...
                    <div className="flex flex-row">
                    <div className="mb-4 mr-4">
                    <label className="form-label inline-block uppercase text-gray-700 text-sm font-bold mb-2" htmlFor="zip">
                      Zip Code
                    </label>
                  ...
                  <div className="mb-6 mr-4">
                    <label className="form-label inline-block uppercase text-gray-700 text-sm font-bold mb-2" htmlFor="city">
                      City
                    </label>
                  ...
                  <div className="mb-6 mr-4">
                  <label className="form-label inline-block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="region">
                    Region
                  </label>
                  <div className="relative">
                    <select value={region} onChange={e=>setRegion(e.target.value)}  className="block appearance-none w-40 bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="region">
                      <option>1</option>
                      <option>2</option>
                      <option>3</option>
                    </select>
                  ...
                  <div className="mb-6 mr-4">
                  <label className="form-label inline-block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="country">
                    Country
                  </label>
                  <div className="relative">
                    <select value={country} onChange={e=>setCountry(e.target.value)}  className="block appearance-none w-40 bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="country">
                      <option>1</option>
                      <option>2</option>
                      <option>3</option>
                    </select>
                  ...
                  <div className="mb-6 mr-4">
                  <label className="form-label inline-block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="industry">
                    Industry
                  </label>
                  <div className="relative">
                    <select value={industry} onChange={e=>setIndustry(e.target.value)}  className="block appearance-none w-40 bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="industry">
                    <option>1</option>
                      <option>2</option>
                      <option>3</option>
                    </select>
                    ...
                    <div class="mb-3 xl:w-60 mr-4">
                      <label for="address1" class="form-label uppercase inline-block font-bold mb-2 text-gray-700">Current Address</label>
                    ...
                    <div class="mb-3 xl:w-60 mr-4">
                      <label for="address2" class="form-label uppercase inline-block font-bold mb-2 text-gray-700">Permanent Address</label>
                    ...
                    <div class="mb-3 xl:w-60 mr-4">
                      <label for="address3" class="form-label uppercase inline-block font-bold mb-2 text-gray-700">Billing Address</label>
                  ...
                  <div className="mb-6 mr-4">
                  <label for="address3" class="form-label uppercase inline-block font-bold mb-2 text-gray-700">Status:</label>
